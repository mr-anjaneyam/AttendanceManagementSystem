    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/SRI/Desktop/Attendance Management System using Face Recognition/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\SRI\Desktop\Attendance Management System using Face Recognition\AttendancemProjects\Attendace_management_system\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                cs = 'C:/Users/SRI/Desktop/Attendance Management System using Face Recognition/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\SRI\Desktop\Attendance Management System using Face Recognition\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'admin':
            if password == '1111':
                ...
                cs = 'C:/Users/SRI/Desktop/Attendance Management System using Face Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
